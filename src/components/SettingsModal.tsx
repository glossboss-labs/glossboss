...
import {
  ...
  Box } from
'@mantine/core';
import { Key, BookOpen, Check, AlertCircle, RefreshCw, X, ExternalLink, Search, Eye } from 'lucide-react';
import {
  getDeepLSettings,
  saveDeepLSettings,
  clearDeepLSettings,
...
import {
  ...
  type FetchResult } from
'@/lib/glossary/wp-fetcher';
...
}: {glossary: Glossary;opened: boolean;onClose: () => void;}) {
...
}: {sourceText: string;glossary: Glossary;}) {
...
export function SettingsModal({
  ...
  const handleLoadGlossary = useCallback(async (forceRefresh = false) => {
          ...
          <Tabs.Panel value="api">
            <Stack gap="md">
              ...
              <div data-ev-id="ev_a06444cf83">
                <Text size="sm" fw={500} mb={4}>API Type</Text>
                <SegmentedControl
                  value={apiType}
                  onChange={(value) => {
                ...
                <Text size="xs" c="dimmed" mt={4}>
                  Free: 500,000 chars/month â¢ Pro: Pay per use
                </Text>
              </div>
                  ...
                  <>
                      ...
                      color={testResult.usage.used / testResult.usage.limit > 0.9 ? 'red' : 'blue'} />
                        ...
                        <Text size="xs" c="dimmed">
                          {testResult.usage.used.toLocaleString()} / {testResult.usage.limit.toLocaleString()} characters
                        </Text>
                      </>
                  }
                  </Stack>
              ...
              <Paper p="md" withBorder>
                  <Stack gap="sm">
                    ...
                    <Group justify="space-between">
                      <Group gap="xs">
                        ...
                        <Text size="sm" c="dimmed">({glossary.targetLocale})</Text>
                      </Group>
                  ...
                  <>
                        ...
                        <div data-ev-id="ev_898c72be1c">
                          <Text size="xs" fw={500} mb={4}>Terms in selected text:</Text>
