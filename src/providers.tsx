...
const resolver: CSSVariablesResolver = () => ({
  ...
  light: {
    ...
    '--gb-surface-2': '#e8e8ea',
    '--gb-surface-3': '#dcdce0',
    '--gb-border-subtle': '#d5d5d9',
    '--gb-border-default': '#c0c0c6',
    '--gb-border-strong': '#a0a0a8',
    '--gb-text-primary': '#0a0a0a',
    '--gb-text-secondary': '#404040',
    '--gb-text-tertiary': '#636366',
    ...
    '--mantine-color-default-border': '#d5d5d9',
  },
  dark: {
    '--gb-surface-0': '#0a0a0a',
    '--gb-surface-1': '#141414',
