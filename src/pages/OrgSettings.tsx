...
export default function OrgSettings() {
  ...
  const isOwner = useMemo(
    () => myMembership?.role === 'owner' || org?.owner_id === user?.id,
    [myMembership, org?.owner_id, user?.id],
  );
        ...
        <>
          <MotionDiv variants={staggerPageVariants} initial="hidden" animate="visible">
            <Stack gap="lg">
              ...
              {/* Tabs */}
              <MotionDiv variants={fadeVariants}>
                <Tabs value={activeTab} onChange={(tab) => tab && setActiveTab(tab)}>
                  <Tabs.List>
                                    ...
                                    <Group justify="space-between" align="center" wrap="nowrap">
                                      ...
                                      <Group gap="xs">
                                        <CopyButton value={inviteUrl}>
                                          {({ copied, copy }) => (
                                            <Tooltip
                                              label={copied ? t('Copied') : t('Copy invite link')}
                                            >
                                              <ActionIcon
                                                variant="subtle"
                                                size="sm"
